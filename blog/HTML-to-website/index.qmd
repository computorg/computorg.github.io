...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {{< include /assets/_includes/figure.html path="assets/img/gh-pages-config.png" class="img-fluid rounded z-depth-1" zoomable=true  >}}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {{< include /assets/_includes/figure.html path="assets/img/about-gh-repos-webpage.png" class="img-fluid rounded z-depth-1" zoomable=true  >}}
    </div>
</div>
